defmodule RedWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: RedWeb.Gettext
  ...
  def header(assigns) do
    ...
    <header class={[
      ...
      <div>
        <h1 class="text-xl text-center font-semibold leading-8 text-zinc-800">
          <%= render_slot(@inner_block) %>
        </h1>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RedWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RedWeb.Gettext, "errors", msg, opts)
    end
  end
